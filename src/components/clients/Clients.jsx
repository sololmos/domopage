          ...
          <div className="col-sm-6 mb-3 mb-sm-0 border-opacity-10">
            <div className="card text-start bg-primary position-relative ">
              <div className="card-body">
                <h5 className="card-title text-start text-white fs-4 fw-semibold">Get in touch with us</h5>
                <p className="card-text text-start text-white fs-6 w-50 py-2" style={{  opacity: 0.7 }}>Maecenas sed diam eget risus varius blandit sit amet non magna.</p>
                <a href="#" className="btn text-white border-white btn-outline-secondary start-0">Hire us</a>
              </div>
            </div>
          </div>
          <div className="col-sm-6 ">
            <div className="card border-opacity-10 text-start bg-primary position-relative">
              <div className="card-body text-white">
                <h5 className="card-title text-white text-start fs-4 fw-semibold">Our Projects</h5>
                <p className="card-text  text-white fs-6 w-50 py-2" style={{  opacity: 0.7 }}>Maecenas sed diam eget risus varius blandit sit amet non magna.</p>
                <a href="#" className="btn text-white border-white btn-outline-secondary start-0 ">See Projects</a>
                <img src={img} alt='img' className='position-absolute bottom-0 end-0' style={{ maxWidth: "200px" }} />
              </div>
            </div>
          </div>
        </div>
